...
function Content() {
  return (
    <>
      <h2 id="the-trial-population-and-scope">01 • The trial population and scope</h2>
      ...
      <h2 id="documented-cardiovascular-reduction">02 • Documented cardiovascular reduction</h2>
      ...
      <h2 id="defining-the-kidney-endpoints">03 • Defining the kidney endpoints</h2>
      ...
      <h2 id="tracking-egfr-and-uacr">04 • Tracking eGFR and UACR</h2>
      ...
      <h2 id="practical-metabolic-logging">05 • Practical metabolic logging</h2>
      ...
      <h2 id="translating-trial-data-to-daily-use">06 • Translating trial data to daily use</h2>
      ...
      <h2 id="faq">FAQ</h2>
        <h3 id="faq-1">What is the SELECT trial?</h3>
        ...
        <h3 id="faq-2">What were the main cardiovascular findings of the SELECT trial?</h3>
        ...
        <h3 id="faq-3">What kidney outcomes did the SELECT trial measure?</h3>
        ...
        <h3 id="faq-4">Why should eGFR and UACR be tracked?</h3>
