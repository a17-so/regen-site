...
function Content() {
  return (
    <>
      <h2 id="mechanism"><span className="lib-ch-num" aria-hidden="true">01</span>Mechanism</h2>
      ...
      <h2 id="expression"><span className="lib-ch-num" aria-hidden="true">02</span>Expression</h2>
      ...
      <h2 id="dynamics"><span className="lib-ch-num" aria-hidden="true">03</span>Dynamics</h2>
      ...
      <h2 id="regulatory"><span className="lib-ch-num" aria-hidden="true">05</span>Regulatory</h2>
      ...
      <div className="lib-faq">
        ...
        <details>
          <summary>Does Selank require FDA approval for clinical use?</summary>
          <p>Yes. Selank is not FDA-approved for human use and is classified exclusively for laboratory research purposes.</p>
        </details>
        <details>
          <summary>Which specific genes does this peptide modulate?</summary>
        ...
        <details>
          <summary>How fast does the peptide alter mRNA expression?</summary>
...
const post: PostMeta = {
  ...
  takeaways: [
    "Selank modulates the inflammatory baseline through rapid gene-expression changes in animal models.",
