...
function Content() {
  return (
    <>
      <h2 id="preclinical-status"><span className="lib-ch-num" aria-hidden="true">01</span>Preclinical</h2>
      ...
      <h2 id="biomarker-tracking"><span className="lib-ch-num" aria-hidden="true">02</span>Biomarkers</h2>
      ...
      <h2 id="metabolic-conditions"><span className="lib-ch-num" aria-hidden="true">03</span>Cachexia</h2>
      ...
      <h2 id="human-trials"><span className="lib-ch-num" aria-hidden="true">04</span>Validation</h2>
      ...
      <h2 id="systemic-pathways"><span className="lib-ch-num" aria-hidden="true">05</span>Pathways</h2>
      ...
      <h2 id="objective-monitoring"><span className="lib-ch-num" aria-hidden="true">06</span>Monitoring</h2>
      ...
      <div className="lib-faq">
        ...
        <details>
          <summary>What is the clinical status of BPC-157?</summary>
        ...
        <details>
          <summary>Is GHK-Cu FDA approved for human use?</summary>
        ...
        <details>
          <summary>Which biomarkers should be tracked during peptide research?</summary>
...
const post: PostMeta = {
  ...
  takeaways: [
    "Neither BPC-157 nor GHK-Cu has an approved formulation or an established clinical dosing regimen.",
