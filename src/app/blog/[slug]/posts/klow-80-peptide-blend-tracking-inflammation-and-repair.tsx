...
function Content() {
  return (
    <>
      <h2 id="what-the-blend-contains">01 — What the blend contains</h2>
      ...
      <h2 id="kpv-and-systemic-inflammation">02 — KPV and systemic inflammation</h2>
      ...
      <h2 id="bpc-157-for-musculoskeletal-healing">03 — BPC-157 for musculoskeletal healing</h2>
      ...
      <h2 id="the-challenge-of-formulation-strategies">04 — The challenge of formulation strategies</h2>
      ...
      <h2 id="tracking-markers-instead-of-guessing">05 — Tracking markers instead of guessing</h2>
      ...
      <h2 id="regulatory-status-and-sports-performance">06 — Regulatory status and sports performance</h2>
      ...
      <h2 id="faq">FAQ</h2>
        <h3 id="faq-1">How much klow peptide should I take?</h3>
        ...
        <h3 id="faq-2">Where to inject klow peptide?</h3>
        ...
        <h3 id="faq-3">Is KLOW peptide available in the USA?</h3>
        ...
        <h3 id="faq-4">How long does it take for klow peptide to kick in?</h3>
