...
function Content() {
  return (
    <>
      <h2 id="divergence"><span className="lib-ch-num" aria-hidden="true">01</span>Divergence</h2>
      ...
      <h2 id="validity"><span className="lib-ch-num" aria-hidden="true">03</span>Validity</h2>
      ...
      <h2 id="monitoring"><span className="lib-ch-num" aria-hidden="true">04</span>Monitoring</h2>
      ...
      <h2 id="integration"><span className="lib-ch-num" aria-hidden="true">06</span>Integration</h2>
      ...
      <div className="lib-faq">
        ...
        <details>
          <summary>Is Melanotan II approved for human use?</summary>
          <p>No. Melanotan II lacks FDA approval for human use and is strictly sold for research purposes only.</p>
        </details>
        <details>
          <summary>What is Bremelanotide (PT-141) approved to treat?</summary>
        ...
        <details>
          <summary>Did the RECONNECT trials show large physiological improvements for PT-141?</summary>
        ...
        <details>
          <summary>Are the subjective surveys used in HSDD trials reliable?</summary>
...
const post: PostMeta = {
  ...
  takeaways: [
    "PT-141 (bremelanotide) holds FDA approval for a sexual health indication; Melanotan II is an unapproved research compound.",
