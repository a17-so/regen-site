...
function Content() {
  return (
    <>
      ...
      <h2 id="regulation">02 Regulation</h2>
      ...
      <h2 id="biomarkers">03 Biomarkers</h2>
      ...
      <h2 id="faq">FAQ</h2>
        <h3 id="faq-1">Is AOD-9604 FDA-approved for weight loss?</h3>
        <p>No. AOD-9604 is not FDA-approved for human use as a weight-loss medication and is sold strictly for research purposes.</p>
        <h3 id="faq-2">Does GRAS status mean AOD-9604 is effective for fat loss?</h3>
        ...
        <h3 id="faq-3">What metabolic markers should be tracked instead of relying on AOD-9604?</h3>
        ...
        <h3 id="faq-4">Did AOD-9604 succeed in clinical trials for obesity?</h3>
