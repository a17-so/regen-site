...
function Content() {
  return (
    <>
      <h2 id="01-delivery"><span className="lib-ch-num" aria-hidden="true">01</span>Delivery</h2>
      ...
      <h2 id="02-efficacy"><span className="lib-ch-num" aria-hidden="true">02</span>Efficacy</h2>
      ...
      <h2 id="03-glycemic"><span className="lib-ch-num" aria-hidden="true">03</span>Glycemic</h2>
      ...
      <h2 id="04-trajectory"><span className="lib-ch-num" aria-hidden="true">04</span>Trajectory</h2>
      ...
      <h2 id="05-velocity"><span className="lib-ch-num" aria-hidden="true">05</span>Velocity</h2>
      ...
      <h2 id="06-modulation"><span className="lib-ch-num" aria-hidden="true">06</span>Modulation</h2>
      ...
      <div className="lib-faq">
        ...
        <details>
          <summary>Does orforglipron require strict fasting for absorption?</summary>
        ...
        <details>
          <summary>What is the expected weight loss ceiling for orforglipron?</summary>
        ...
        <details>
          <summary>When should someone transition from oral GLP-1s to injectable dual agonists?</summary>
...
const post: PostMeta = {
  ...
  takeaways: [
    "Orforglipron is a non-peptide small molecule, so it takes daily oral dosing without fasting constraints.",
