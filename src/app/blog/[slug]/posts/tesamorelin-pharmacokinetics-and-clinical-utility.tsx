...
function Content() {
  return (
    <>
      ...
      <h2 id="responders">03 Responders</h2>
      ...
      <h2 id="faq">FAQ</h2>
        <h3 id="faq-1">What is the primary clinical utility of tesamorelin?</h3>
        ...
        <h3 id="faq-2">How does tesamorelin affect liver biomarkers?</h3>
        ...
        <h3 id="faq-3">Does tesamorelin reduce generalized body weight?</h3>
