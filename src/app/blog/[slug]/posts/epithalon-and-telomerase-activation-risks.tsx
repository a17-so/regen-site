...
function Content() {
  return (
    <>
      <h2 id="biomarker-protocols">01 Biomarkers</h2>
      ...
      <h2 id="inflammatory-metrics">02 Inflammation</h2>
      ...
      <h2 id="systemic-dynamics">03 Dynamics</h2>
      ...
      <h2 id="faq">FAQ</h2>
        <h3 id="faq-1">Is epithalon FDA approved for human use?</h3>
        ...
        <h3 id="faq-2">What biomarkers are tracked alongside high-risk metabolic interventions?</h3>
        ...
        <h3 id="faq-3">Why are IL-6 and CRP important when evaluating metabolic risks?</h3>
