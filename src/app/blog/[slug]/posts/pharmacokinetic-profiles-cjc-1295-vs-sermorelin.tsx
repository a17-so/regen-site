...
function Content() {
  return (
    <>
      <h2 id="architecture"><span className="lib-ch-num" aria-hidden="true">01</span>Architecture</h2>
      ...
      <h2 id="clearance"><span className="lib-ch-num" aria-hidden="true">02</span>Clearance</h2>
      ...
      <h2 id="saturation"><span className="lib-ch-num" aria-hidden="true">03</span>Saturation</h2>
      ...
      <h2 id="modulation"><span className="lib-ch-num" aria-hidden="true">05</span>Modulation</h2>
      ...
      <h2 id="dynamics"><span className="lib-ch-num" aria-hidden="true">06</span>Dynamics</h2>
      ...
      <div className="lib-faq">
        ...
        <details>
          <summary>What is the primary difference in half-life between CJC-1295 and Sermorelin?</summary>
        ...
        <details>
          <summary>Why do researchers track fasting glucose when evaluating CJC-1295?</summary>
        ...
        <details>
          <summary>Are CJC-1295 and Sermorelin FDA-approved for metabolic use?</summary>
...
const post: PostMeta = {
  ...
  takeaways: [
    "CJC-1295 maintains elevated binding for over a week; Sermorelin clears the bloodstream in minutes.",
